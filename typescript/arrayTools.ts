...
export const removalRepeat = function<T>(array: T[], key: string = ''): T[] {
  if (isValueList(array)) {
    ...
    for (let source of array as Array<IObject>) {
 ...
 * @returns {number}
 */
export const len = function(source: Object | Array<any> | String): number {
 ...
 */
export const nth = function(array: Array<any>, index: number = 0) {
 ...
 * @returns {T[]}
 */
export const removeCopy = function<T>(
  array: T[],
